        ...
        <?php
          ...
          <div class="col-lg-12 ftco-animate">
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.php" class="block-20 text-center">
                  <?php echo "<img src='" . $blog_record['image'] . "' height= 300px; width=300px;>"; ?>
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#"><?php echo $blog_record['DATE']; ?></a></div>
		                  <div><a href="#">Admin</a></div>
		                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 0</a></div>
		                </div>
		                <h3 class="heading"><a href="#"><?php echo $blog_record['TITLE']; ?></a></h3>
