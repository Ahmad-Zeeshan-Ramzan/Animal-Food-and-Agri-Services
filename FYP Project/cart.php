  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-cart">
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(images/b.png);"></div></td>
						        
						        <td class="product-name">
						        	<h3>Buffalo Oil Cake</h3>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(images/Pallet.jpg);"></div></td>
    		...
    		<div class="row justify-content-end">
    			...
    			<div class="col-lg-12 mt-5 cart-wrap ftco-animate text-center">
    				<div class="cart-total mb-3">
    					<h3>Cart Totals</h3>
    					<p class="d-flex">
    						<span>Subtotal</span>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by WE CARE Team <i class="icon-heart color-danger" aria-hidden="true"></i> </a>
