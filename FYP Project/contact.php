...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['upload'])) {
        ...
        $f_message = $_POST['message'];
            ...
            $query = "INSERT INTO contact(NAME, EMAIL, SUBJECT, MESSAGE)VALUES('$f_name', '$f_email', '$f_subject', '$f_message')";
...
<html lang="en">
  <head>
    <title>We Care - Contact Us</title>
    <meta charset="utf-8">
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> LDA Chock, Near Superior University, Lahore</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://+92 321 1234567">+92 321 1234567</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="#">wecare@email.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website</span> <a href="#">wecare.com</a></p>
	          </div>
          </div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="contact.php" class="bg-white p-5 contact-form" method="post" enctype="multipart/form-data"
