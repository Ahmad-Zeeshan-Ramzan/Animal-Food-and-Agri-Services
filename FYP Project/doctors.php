      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Doctor's Team</span></p>
        ...
        <?php
          ...
          <div class="col-lg-12 ftco-animate">
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="doctor-single.php" class="block-20 text-center">
                  <?php echo "<img src='" . $doctor_record['image'] . "' height= 300px; width=300px;>"; ?>
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#"><?php echo $doctor_record['SPECIALIST']; ?></a></div>
		                  <div><a href="#">Admin</a></div>
		                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 0</a></div>
		                </div>
		                <h3 class="heading"><a href="#"><?php echo $doctor_record['EXPERIENCE']; ?></a></h3>
		                <p><?php echo $doctor_record['ABOUT']; ?></p>
		                <p><a href="doctor-single.php" class="btn btn-primary py-2 px-3">Read more</a></p>
		              </div>
		            </div>
		          </div>
              <?php } ?>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with by WE CARE Team <i class="icon-heart color-danger" aria-hidden="true"></i> 
